...
class DataMax{
	...
	function addbarcode($orientation, $width, $height, $posX, $posY, $data, $simples = false){
		/*
		  ...
		  1 - Normal
		 */
		// Faz tratamento especifico para datamax
	...
	function getall(){
		$text = array();
		$text[] = chr("002")."LC".$this->margin_left; // comando de entrada de etiqueta
	...
	function setmargin_left($margin_left){
		$this->margin_left = str_pad($margin_left, 4, "0", STR_PAD_LEFT);
	}
