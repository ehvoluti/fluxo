	...
	$.extend({
		tablesorter: new function() {
			...
			this.defaults = {
				...
				headerList: [],
				locale: "br",
				format:{us: {decimal: '.', date: '/'}, en: {decimal: '.', date: '/'}, eu: {decimal: ',', date: '.'}, de: {decimal: ',', date: '.'}, br: {decimal: ',', date: '/'}},
				onRenderHeader: null,
			...
			this.formatDecimal = function(s,config) {
				if (config.locale != "us") {
					s = s.replace(".","").replace(config.format[config.locale]["decimal"], config.format["us"]["decimal"]);
				}
				return s;
			};
